...
L:RegisterTranslations("ruRU", function() return {
	["DESCRIPTION"] = "Отслеживает деньги всех ваших персонажей",
	["TEXT_TOTAL"] = "Всего",
	["TEXT_SESSION_RESET"] = "Сброс сеанса",
	["TEXT_THIS_SESSION"] = "Этот сеанс",
	["TEXT_GAINED"] = "Приобретено",
	["TEXT_SPENT"] = "Потрачено",
	["TEXT_AMOUNT"] = "Количество",
	["TEXT_PER_HOUR"] = "За час",
	
	["MENU_RESET_SESSION"] = "Сброс савнса",
	["MENU_CHARACTER_SPECIFIC_CASHFLOW"] = "Показать денежный поток конткретного персонажа",
	["MENU_PURGE"] = "Очистить",
	["MENU_SHOW_GRAPHICAL"] = "Показать с монетами",
	["MENU_SHOW_FULL"] = "Показать полный стиль",
	["MENU_SHOW_SHORT"] = "Показать короткий стиль",
	["MENU_SHOW_CONDENSED"] = "Показать сжатый стиль",
	["SIMPLIFIED_TOOLTIP"] = "Упрощенная подсказка",
	["SHOW_PER_HOUR_CASHFLOW"] = "Показать денежный поток за час",
	
	["TEXT_SESSION_RESET"] = "Санс сброшен.",
	["TEXT_CHARACTERS"] = "Персонажи",
	["TEXT_PROFIT"] = "Прибыль",
	["TEXT_LOSS"] = "Потеря",
	
	["HINT"] = "Нажмите, чтобы взять деньги"
}end)
