local L = AceLibrary("AceLocale-2.0"):new("DuraTek")
...
L:RegisterTranslations("enUS", function() return { ["Total"] = true } end)
L:RegisterTranslations("ruRU", function() return { ["Total"] = "Итого" } end)
...
function FuBar_DuraTek:OnTooltipUpdate()
	...
	cat:AddLine("text", L"Total", "text2", (self.totalcost > 0) and abacus:FormatMoneyFull(self.totalcost, true) or "",
