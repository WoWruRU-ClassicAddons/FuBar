...
function ProfessionsFu:OnTooltipUpdate()
	...
	if (self.hasAlchemy or self.hasBlacksmithing or self.hasEnchanting or self.hasEngineering or self.hasHerbalism or self.hasLeatherworking or self.hasMining or self.hasSkinning or self.hasTailoring) then
