...
L:RegisterTranslations("ruRU", function() return {
	DESCRIPTION = "Включение/Выключение аддонов для вашего персонажа в игре.",

	LOADED = "Загружено",
	WILL_NOT_LOAD = "Не загружается",
	DISABLED_IN_MCP = "Отключен в MCP",

	OPT_SHOW_ENABLED = "Показать Включено/Отключено",
	OPT_SHOW_ENABLED_DESC = "Показать в тексте аддона включено/отключено",
	OPT_SHOW_SECURITY = "Показать безопасность",
	OPT_SHOW_SECURITY_DESC = "Показать информацию безопасности blizzard",
	OPT_SHOW_NOTES = "Показать заметки",
	OPT_SHOW_NOTES_DESC = "Показаметь заметки аддонов в подсказках",
	OPT_NOTE_LEN = "Максимальная длина заметок",
	OPT_NOTE_LEN_DESC = "Если длина заметок больше, чем количество символов, они будут сокращены.",

	SECURE = "Безопасный",
	INSECURE = "Небезопасный",
	BANNED = "Запрещен",

	ONDEMAND = "Shift+нажатие для загрузки",

	HINT = "Alt+нажатие для перезагрузки",
} end )
