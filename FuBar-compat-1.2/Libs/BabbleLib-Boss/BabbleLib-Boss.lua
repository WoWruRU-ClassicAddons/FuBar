...
if locale ~= "frFR" and locale ~= "ruRU" and locale ~= "deDE" and locale ~= "zhCN" and locale ~= "koKR" then
	locale = "enUS"
end
...
elseif locale == "ruRU" then
	function initBosses()
		bosses = {
			-- Raid bosses
			NEFARIAN = "Нефариан",
			VAELASTRASZ_THE_CORRUPT = "Валестраз Порочный",
			RAZORGORE_THE_UNTAMED = "Бритвосмерт Неукротимый",
			BROODLORD_LASHLAYER = "Предводитель драконов Разящий Бич",
			CHROMAGGUS = "Хромаггус",
			EBONROC = "Черноскал",
			FIREMAW = "Огнечрев",
			FLAMEGOR = "Пламегор",
			MAJORDOMO_EXECUTUS = "Мажордом Экзекутус",
			RAGNAROS = "Рагнарос",
			BARON_GEDDON = "Барон Геддон",
			GOLEMAGG_THE_INCINERATOR = "Големагг Испепелитель",
			GARR = "Гарр",
			SULFURON_HARBINGER = "Предвестник Сульфурон",
			SHAZZRAH = "Шаззрах",
			LUCIFRON = "Люцифрон",
			GEHENNAS = "Гееннас",
			MAGMADAR = "Магмадар",
			ONYXIA = "Ониксия",
			AZUREGOS = "Азурегос",
			LORD_KAZZAK = "Лорд Каззак",
			YSONDRE = "Исондра",
			EMERISS = "Эмерисс",
			TAERAR = "Таэрар",
			LETHON = "Летон",
			HIGH_PRIESTESS_JEKLIK = "Верховная жрица Джеклик",
			HIGH_PRIEST_VENOXIS = "Верховный жрец Веноксис",
			HIGH_PRIEST_THEKAL = "Верховный жрец Текал",
			HIGH_PRIESTESS_ARLOKK = "Верховная жрица Арлокк",
			HIGH_PRIESTESS_MAR_LI = "Верховная жрица Мар'ли",
			JIN_DO_THE_HEXXER = "Мастер проклятий Джин'до",
			BLOODLORD_MANDOKIR = "Мандокир Повелитель Крови",
			GAHZ_RANKA = "Газ'ранка",
			GRI_LEK = "Гри'лек",
			HAZZA_RAH = "Хазза'рах",
			RENATAKI = "Ренатаки",
			WUSHOOLAY = "Вушулай",
			HAKKAR = "Хаккар",
			AYAMISS_THE_HUNTER = "Айамисса Охотница",
			BURU_THE_GORGER = "Буру Ненасытный",
			GENERAL_RAJAXX = "Генерал Раджакс",
			ANUBISATH_GUARDIAN = "Анубисат-страж",
			OSSIRIAN_THE_UNSCARRED = "Оссириан Неуязвимый",
			LORD_KRI = "Лорд Кри",
			PRINCESS_YAUJ = "Принцесса Яудж",
			VEM = "Вем",
			EYE_OF_CTHUN = "Око К'Туна",
			ANUBISATH_DEFENDER = "Анубисат-защитник",
			FANKRISS_THE_UNYIELDING = "Фанкрисс Неприклонный",
			PRINCESS_HUHURAN = "Принцесса Хухуран",
			OURO = "Оуро",
			BATTLEGUARD_SARTURA = "Боевой страж Сартура",
			THE_PROPHET_SKERAM = "Пророк Скерам",
			EMPEROR_VEKLOR = "Император Век'лор",
			EMPEROR_VEKNILASH = "Император Век'нилаш",
			VISCIDUS = "Нечистотон",
			-- Regular bosses
			ALZZIN_THE_WILDSHAPER = "Алззин Перевертень",
			AMBASSADOR_FLAMELASH = "Посол Огнехлыст",
			ANGER_REL = "Гнев'рел",
			ARCHIVIST_GALFORD = "Архивариус Галфорд",
			ATAL_ALARION = "Атал'аларион",
			AVATAR_OF_HAKKAR = "Аватара Хаккара",
			BAEL_GAR = "Бейл'Гор",
			BALNAZZAR = "Балназзар",
			BARONESS_ANASTARI = "Баронесса Анастари",
			BARON_RIVENDARE = "Барон Ривендер",
			CANNON_MASTER_WILLEY = "Мастер-канонир Вилли",
			CAPTAIN_KROMCRUSH = "Капитан Давигром",
			CELEBRAS_THE_CURSED = "Келебрас Проклятый",
			CRYSTAL_FANG = "Хрустальный Клык",
			DARKMASTER_GANDLING = "Темный магистр Гандлинг",
			DOCTOR_THEOLEN_KRASTINOV = "Доктор Теолен Крастинов",
			DOOM_REL = "Рок'рел",
			DOPE_REL = "Праздн'рел",
			DREAMSCYTHE = "Жнец Снов",
			EMPEROR_DAGRAN_THAURISSAN = "Император Дагран Тауриссан",
			FINEOUS_DARKVIRE = "Финий Темнострой",
			GASHER = "Ранокол",
			GENERAL_ANGERFORGE = "Генерал Кузня Гнева",
			GENERAL_DRAKKISATH = "Генерал Драккисат",
			GLOOM_REL = "Мрак'нел",
			GOLEM_LORD_ARGELMACH = "Повелитель големов Аргелмах",
			GORALUK_ANVILCRACK = "Горалук Треснувшая Наковальня",
			GUARD_FENGUS = "Стражник Фенгус",
			GUARD_MOL_DAR = "Стражник Мол'дар",
			GUARD_SLIP_KIK = "Стражник Слип'кик",
			GYTH = "Гит",
			HALYCON = "Халикон",
			HATE_REL = "Злоб'рел",
			HAZZAS = "Хаззас",
			HEARTHSINGER_FORRESTEN = "Певчий Форрестен",
			HIGH_INTERROGATOR_GERSTAHN = "Верховный дознаватель Герштан",
			HIGHLORD_OMOKK = "Вождь Омокк",
			HUKKU = "Хукку",
			HURLEY_BLACKBREATH = "Харли Чернопых",
			HYDROSPAWN = "Гидротварь",
			ILLYANNA_RAVENOAK = "Иллиана Воронья Ольха",
			IMMOL_THAR = "Бессмер'тер",
			INSTRUCTOR_MALICIA = "Инструктор Коварница",
			JAMMAL_AN_THE_PROPHET = "Джаммал'ан Пророк",
			JANDICE_BAROV = "Джандис Барова",
			KING_GORDOK = "Король Гордок",
			KIRTONOS_THE_HERALD = "Киртонос Глашатай",
			LADY_ILLUCIA_BAROV = "Леди Иллюсия Барова",
			LANDSLIDE = "Сель",
			LETHTENDRIS = "Лефтендрис",
			LORD_ALEXEI_BAROV = "Лорд Алексей Баров",
			LORD_INCENDIUS = "Лорд Опалитель",
			LORD_VYLETONGUE = "Лорд Злоязыкий",
			LOREKEEPER_POLKELT = "Сказитель Полкелт",
			LORO = "Лоро",
			MAGISTER_KALENDRIS = "Магистр Календрис",
			MAGISTRATE_BARTHILAS = "Мировой судья Бартилас",
			MAGMUS = "Магмус",
			MALEKI_THE_PALLID = "Малекай Бледный",
			MARDUK_BLACKPOOL = "Мардук Блэкпул",
			MESHLOK_THE_HARVESTER = "Мешлок Жнец",
			MIJAN = "Миджан",
			MORPHAZ = "Морфаз",
			MOTHER_SMOLDERWEB = "Мать Дымная Паутина",
			NERUB_ENKAN = "Неруб'энкан",
			NOXXION = "Ноксион",
			OGOM_THE_WRETCHED = "Огом Презренный",
			OVERLORD_WYRMTHALAK = "Властитель Змейталак",
			PHALANX = "Фаланкс",
			PLUGGER_SPAZZRING = "Штоппор Наливалс",
			POSTMASTER_MALOWN = "Почтальон Мэлоун",
			PRINCESS_MOIRA_BRONZEBEARD = "Принцесса Мойра Бронзобород",
			PRINCESS_THERADRAS = "Принцесса Терадрас",
			PRINCE_TORTHELDRIN = "Принц Тортелдрин",
			PUSILLIN = "Пузиллин",
			PYROGUARD_EMBERSEER = "Пиростраж Углевзор",
			RAMSTEIN_THE_GORGER = "Рамштайн Ненасытный",
			RAS_FROSTWHISPER = "Рас Ледяной Шепот",
			RATTLEGORE = "Громоклин",
			RAZORLASH = "Бритвохлест",
			WARCHIEF_REND_BLACKHAND = "Вождь Ренд Чернорук",
			RIBBLY_SCREWSPIGOT = "Риббли Крутипроб",
			ROTGRIP = "Гнилопасть",
			SEETH_REL = "Беше'рел",
			SHADE_OF_ERANIKUS = "Тень Эраникуса",
			SHADOW_HUNTER_VOSH_GAJIN = "Темная охотница Вос'гаджин",
			SOLAKAR_FLAMEWREATH = "Солакарский огнечервь",
			STOMPER_KREEG = "Топотун Криг",
			TENDRIS_WARPWOOD = "Тендрис Криводрев",
			THE_BEAST = "Зверь",
			THE_RAVENIAN = "Равениан",
			TIMMY_THE_CRUEL = "Тимми Беспощадный",
			TINKERER_GIZLOCK = "Ремонтник Гизлок",
			TSU_ZEE = "Цу'зи",
			VECTUS = "Вектус",
			VILE_REL = "Гнус'рел",
			WAR_MASTER_VOONE = "Воевода Вун",
			WEAVER = "Ткачик",
			ZEVRIM_THORNHOOF = "Зеврим Терновое Копыто",
			ZOLO = "Золо",
 			ZUL_LOR = "Зул'Лор",
		}
	end
