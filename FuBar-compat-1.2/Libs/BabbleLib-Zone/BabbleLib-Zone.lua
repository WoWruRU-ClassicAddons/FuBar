...
elseif locale == "ruRU" then
	function initZones()
		zones = {
			ALTERAC_MOUNTAINS = "Альтеракские горы",
			ALTERAC_VALLEY = "Альтеракская долина",
			ARATHI_BASIN = "Низина Арати",
			ARATHI_HIGHLANDS = "Нагорье Арати",
			ASHENVALE = "Ясеневый лес",
			AZSHARA = "Азшара",
			BADLANDS = "Бесплодные земли",
			BARRENS = "Степи",
			BLACKFATHOM_DEEPS = "Непроглядная Пучина",
			BLACKROCK_DEPTHS = "Глубины Черной горы",
			BLACKROCK_MOUNTAIN = "Черная гора",
			BLACKROCK_SPIRE = "Пик Черной горы",
			BLACKWING_LAIR = "Логово Крыла Тьмы",
			...
			DEADWIND_PASS = "Перевал Мертвого Ветра",
			DEEPRUN_TRAM = "Подземный поезд",
			DESOLACE = "Пустоши",
			DIRE_MAUL = "Забытый Город",
			DUN_MOROGH = "Дун Морог",
			DUROTAR = "Дуротар",
			DUSKWOOD = "Сумеречный лес",
			DUSTWALLOW_MARSH = "Пылевые топи",
			EASTERN_PLAGUELANDS = "Восточные Чумные земли",
			ELWYNN_FOREST = "Элвиннский лес",
			FELWOOD = "Оскверненный лес",
			FERALAS = "Фералас",
			FORBIDDING_SEA = "Зловещее море",
			GADGETZAN = "Прибамбасск",
			GNOMEREGAN = "Гномреган",
			GREAT_SEA = "Великое море",
			HALL_OF_LEGENDS = "Зал Легенд",
			HILLSBRAD_FOOTHILLS = "Предгорья Хилсбрада",
			HINTERLANDS = "Внутренние земли",
			HYJAL = "Хиджал",
			IRONFORGE = "Стальгорн",
			LOCH_MODAN = "Лок Модан",
			MARAUDON = "Мародон",
			MOLTEN_CORE = "Огненные Недра",
			...
			RUINS_OF_AHN_QIRAJ = "Руины Ан'Киража",
			SCARLET_MONASTERY = "Монастырь Алого ордена",
			SCHOLOMANCE = "Некроситет",
			SEARING_GORGE = "Тлеющее ущелье",
			SHADOWFANG_KEEP = "Крепость Темного Клыка",
			SILITHUS = "Силитус",
			SILVERPINE_FOREST = "Серебряный бор",
			STOCKADE = "Тюрьма",
			STONETALON_MOUNTAINS = "Когтистые горы",
			STORMWIND_CITY = "Штормград",
			STORMWIND_CITY_ALT = "Штормград",
			STRANGLETHORN_VALE = "Тернистая долина",
			STRATHOLME = "Стратхольм",
			SWAMP_OF_SORROWS = "Болото Печали",
			TANARIS = "Танарис",
			TELDRASSIL = "Тельдрассил",
			TEMPLE_OF_AHN_QIRAJ = "Храм Ан'Кираж",
			TEMPLE_OF_ATAL_HAKKAR = "Храм Атал'Хаккара",
			THOUSAND_NEEDLES = "Тысяча Игл",
			THUNDER_BLUFF = "Громовой Утес",
			TIRISFAL_GLADES = "Тирисфальские леса",
			ULDAMAN = "Ульдаман",
			UN_GORO_CRATER = "Кратер Ун'Горо",
			UNDERCITY = "Подгород",
			UNDERCITY_ALT = "Подгород",
			WAILING_CAVERNS = "Пещеры Стенаний",
			WARSONG_GULCH = "Ущелье Песни Войны",
			WESTERN_PLAGUELANDS = "Западные Чумные земли",
