...
FuBar:RegisterChatCommand({"/fubarcl", "/fbcl", "/fbarcl"}, optionsTable)
FuBar:RegisterChatCommand({"/fubar", "/fb", "/fbar"}, function() waterfall:Open('FuBar') end)
waterfall:Register('FuBar', 'aceOptions', optionsTable, 'title','FuBar 2.0. Revision: 12212','colorR', 0, 'colorG', 0.8, 'colorB', 0.9) 
